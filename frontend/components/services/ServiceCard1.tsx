...
const ServiceCard1 = ({data, index}) => {
    return(
            ...
            key={data.title} className="bg-white flex flex-col overflow-hidden rounded-lg shadow-lg hover:scale-[1.03] transition-transform ease-in-out">
                ...
                <div className="flex flex-1 flex-col justify-between p-6">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center mt-10">
                      <p id={index} className="text-xl text-gray-900 mr-5">LEANR MORE</p>
