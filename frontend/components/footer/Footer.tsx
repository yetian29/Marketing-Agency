  ...
  export default function Footer() {
    return (
      <footer className="bg-gray-100" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto w-full py-12 lg:px-10 lg:py-16">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="ml-6 mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                ...
                <div>
                  ...
                  <ul role="list" className="mt-4 space-y-4">
                    {navigation.solutions.map((item) => (
                      <li key={item.name}>
                        <Link href={item.href} className="relative text-base text-black group overflow-hidden">
                ...
                <div className="mt-12 md:mt-0">
                  ...
                  <ul role="list" className="mt-4 space-y-4">
                    {navigation.legal.map((item) => (
                      <li key={item.name}>
                        <Link href={item.href} className="relative text-base text-black overflow-hidden group">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-900 xl:text-center">&copy; 2023 Murkiva Studio. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
